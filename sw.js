...
const CACHE = 'toy-rotation-v0.11.3-hotfix1-safe-storage-recovery-20260831';
...
self.addEventListener('fetch', event => {
  ...
  const bootAsset=/\/(index\.html|config\.js|src\/main\.js|manifest\.webmanifest|startup-diagnostic\.html|startup-diagnostic\.js|storage-recovery-diagnostic\.html|storage-recovery-diagnostic\.js)$/.test(url.pathname);
